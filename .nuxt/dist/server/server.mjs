...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import("./_nuxt/index-Ck99jDa0.js")
  },
  {
    name: "integrantes-integrante",
    path: "/integrantes/:integrante()",
    component: () => import("./_nuxt/_integrante_-BNGjyP9i.js")
  }
];
...
const LazyCfooter = defineAsyncComponent(() => import("./_nuxt/Cfooter-DnMEJhZg.js").then((r) => r["default"] || r.default || r));
const LazyCheader = defineAsyncComponent(() => import("./_nuxt/Cheader-GTM1HWcn.js").then((r) => r["default"] || r.default || r));
